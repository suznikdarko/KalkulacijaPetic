...
# Copy original
shutil.copy2(r'c:\DARKO\KalkulacijaPetric\kuverte.html', r'c:\DARKO\KalkulacijaPetric\kuverte1.html')

with open(r'c:\DARKO\KalkulacijaPetric\kuverte1.html', 'r', encoding='utf-8') as f:
    html = f.read()

# Replace the existing script tag with the appended logic
js_functions = '''
...
if idx != -1:
    html = html[:idx] + js_functions + "\n" + html[idx:]

with open(r'c:\DARKO\KalkulacijaPetric\kuverte1.html', 'w', encoding='utf-8') as f:
    f.write(html)
print("Recreated kuverte1.html with save logic correctly inserted!")
